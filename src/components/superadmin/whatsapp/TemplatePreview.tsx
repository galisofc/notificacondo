...
export function TemplatePreview({ content, className = "" }: TemplatePreviewProps) {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="bg-[#0b141a] rounded-2xl p-4 overflow-hidden">
        {/* Header */}
        <div className="flex items-center gap-3 pb-3 border-b border-white/10">
          ...
          <div>
            <p className="text-white font-medium text-sm">Condomínio Legal</p>
        ...
        <div className="pt-4 space-y-2">
          ...
          <div className="flex justify-start">
            <div className="max-w-[85%] bg-[#202c33] rounded-lg rounded-tl-none p-3 shadow-sm relative">
              {/* Tail */}
      ...
      <p className="text-xs text-muted-foreground mt-3 text-center italic">
        * Os valores são exemplos. Serão substituídos pelos dados reais no envio.
      </p>
    </div>
  );
}
